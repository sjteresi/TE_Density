...
class DensityData:
    ...
    def _supply_density_data_files(path_to_folder):
        ...
        for path_str in os.listdir(path_to_folder):
            file_abspath = os.path.abspath(os.path.join(path_to_folder, path_str))
            if os.path.isfile(file_abspath) and file_abspath.endswith(".h5"):
                raw_file_list.append(file_abspath)
