...
def reformat_seq_iq(input_fasta, genome_name, output_dir, logger):
    ...
    """
    # MAGIC file suffixes
    new_fasta = os.path.abspath(
        os.path.join(output_dir, (genome_name + "_CDS_NewNames.fasta"))
    )
    name_key = os.path.abspath(
        os.path.join(output_dir, (genome_name + "_CDS_Seq_ID_Conversion.txt"))
    )
...
if __name__ == "__main__":
    ...
    args.output_dir = os.path.join(args.output_dir, "Processed_Sequences")
