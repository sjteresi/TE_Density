...
from examples.Blueberry_Expression.src.replace_names_blueberry import te_annot_renamer
...
if __name__ == "__main__":
    ...
    write_cleaned_transposons(cleaned_transposons, args.output_dir, "Blueberry", logger)
